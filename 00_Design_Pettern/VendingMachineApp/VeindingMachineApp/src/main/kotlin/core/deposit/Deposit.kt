package core.deposit

import core.money.Money
import core.counter.MoneyCounter
...
class Deposit(private val moneyList: List<MoneyCounter>) : IDeposit {
    ...
    override fun insertMoney(money: Money, vendingMachine: IVendingMachine): CoreResult<Int?> {
        if (!money.isValid) {
